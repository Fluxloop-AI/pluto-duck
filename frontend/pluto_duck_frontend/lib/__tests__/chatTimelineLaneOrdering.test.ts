    ...
    events: [
      {
        ...
        metadata: { run_id: runId, sequence: 3, event_id: 'evt-reason', phase: 'llm_reasoning' },
      ...
      },
      {
        ...
        metadata: { run_id: runId, sequence: 3, event_id: 'evt-tool-start', tool_call_id: 'tc-exec' },
      ...
      },
      {
        ...
        metadata: { run_id: runId, sequence: 3, event_id: 'evt-approval-start', tool_call_id: 'tc-approval' },
  ...
  const baseEvents = [
    {
      ...
      metadata: { run_id: runId, sequence: 2, event_id: 'evt-read-start', tool_call_id: 'tc-read' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 3, event_id: 'evt-read-end', tool_call_id: 'tc-read' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 4, event_id: 'evt-approval-a-end', tool_call_id: 'tc-approval-a' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 5, event_id: 'evt-edit-start', tool_call_id: 'tc-edit' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 6, event_id: 'evt-edit-error', tool_call_id: 'tc-edit' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 7, event_id: 'evt-approval-b-end', tool_call_id: 'tc-approval-b' },
    ...
    },
    {
      ...
      metadata: { run_id: runId, sequence: 8, event_id: 'evt-final' },
    ...
    events: [
      {
        ...
        metadata: { run_id: runId, sequence: 1, event_id: 'evt-approval-a-start', tool_call_id: 'tc-approval-a' },
      ...
      },
      {
        ...
        metadata: { run_id: runId, sequence: 0, event_id: 'evt-approval-b-start', tool_call_id: 'tc-approval-b' },
